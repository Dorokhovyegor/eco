...
import com.voodoolab.eco.utils.PaymentUtils
import com.voodoolab.eco.utils.microsToString
...
class PaymentActivity : Activity() {
    ...
    private fun possiblyShowGooglePayButton() {
        val isReadyToPayJson = PaymentUtils.isReadyToPayRequest() ?: return
    ...
    private fun requestPayment() {
        ...
        val paymentDataRequestJson = PaymentUtils.getPaymentDataRequest(price)
    ...
    private fun handlePaymentSuccess(paymentData: PaymentData) {
        ...
        try {
            ...
            println("BillingName  ${billingName.toString()}")
